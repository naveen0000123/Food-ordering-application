...
export class LoginComponent implements OnInit {
  ...
  constructor(private router: Router, private toastr: ToastrService,private authService: AuthService ,private logger: LogService) { }
    ...
    this.authService.login(JSON.stringify(f.value))
      .subscribe(
        data => {
          ...
          if(this.isAdmin)
          {
            this.logger.log("Login Sucess as Admin");
          ...
          else
          {
            ...
            this.logger.log("Login Sucess as Customer");
