...
export class AuthService {
  ...
  editprofile(id,name,email,contact,address) {
    return this.http.get(this.baseUri + "/editprofile?id=" + id+"&name="+name+"&email="+email+"&address="+address+"&contact="+contact, { headers: this.headers });
  }
